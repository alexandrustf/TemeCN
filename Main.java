...
public class Main {
    public static void main(String[] args) {
        ...
        m3.buildMatrix("C:\\Users\\Alex Stefan\\Desktop\\MICROSERVICII\\A7IP2019-Microservices\\Tema4CalculNumeric\\src\\a_3.txt", 11);
        m4.buildMatrix("C:\\Users\\Alex Stefan\\Desktop\\MICROSERVICII\\A7IP2019-Microservices\\Tema4CalculNumeric\\src\\a_4.txt", 11);
        m5.buildMatrix("C:\\Users\\Alex Stefan\\Desktop\\MICROSERVICII\\A7IP2019-Microservices\\Tema4CalculNumeric\\src\\a_5.txt", 11);
        ...
        Map<Integer, Map<Integer, Double>> mat = m4.getMatrix();
        ...
        System.out.println("\n\nRezultatul pentru a1 si b1");
        System.out.println(m1.ALG(B1));
        System.out.println("\n\nRezultatul pentru a2 si b2");
        System.out.println(m2.ALG(B2));
        System.out.println("\n\nRezultatul pentru a3 si b3");
        System.out.println(m3.ALG(B3));
        System.out.println("\n\nRezultatul pentru a4 si b4");
